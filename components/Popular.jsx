...
const Popular = () => {
  ...
  return (
    <>
      <div className='flex flex-col justify-center items-center gap-5 pt-8 px-[2rem] md:px-[10rem]'>
        <h3 className='font-bold text-3xl text-[#212245] md:text-4xl pb-4'>Popular Food</h3>
        <div className='flex justify-center items-center gap-12 bg-[#df2020] w-[110%] py-4 text-white rounded text-xl mb-6 md:px-12'>
      ...
      <div className='flex flex-col justify-center items-center md:flex-row md:flex-wrap md:gap-2 md:px-[10rem]'>
    {
      allProduct.map((item)=>(
