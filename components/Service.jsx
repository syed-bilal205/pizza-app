...
const Service = () => {
  return (
    <>
      <div className='bg-white flex justify-center items-center pt-16'>
        <div className='flex flex-col items-center  gap-2'>
            <span className='font-bold text-[#df2020] text-2xl'>What we serve</span>
            <h3 className='font-bold text-[#212245] text-center text-4xl md:text-5xl'>Just sit back at home</h3>
      ...
      <div>
        <div className='bg-white flex flex-col px-[2rem] pt-8 md:flex-row'>
            {
